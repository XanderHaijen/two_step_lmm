function [syntheticImage] = getHyperspectralSyntheticImageGaussianFields(endmembers)
% [syntheticImage] = getHyperspectralSyntheticGaussianFields(endmembers)
%
...
%
% Return an hyperspectral synthetic image by Gaussian Fields method.
%
% Input:
...
abundancies = getAbundanciesSampleGaussianFields(e);
% Check dimensions
